...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Выбор категории слайдера на домашней странице",
						"desc" => "Выберите нужную рубрику",
						"id" => "w2f_slide_categories",
						"type" => "select",
						"options" => $options_categories);						
						
	$options[] = array( "name" => "Количество слайтов",
	...
	$options[] = array( "name" => "Фон по умолчанию",
						"desc" => "Фоновое изображение сайта",
						"id" => "w2f_defaultbg",
						"type" => "upload"); 			
